...
initMotion({"hero": ".hero h1, .tagline, .welcome h2, .welcome .button", "art": ".hero figure img", "reveal": ".table-heading h2, .event-label, .event h2, .event li, .contact h2", "artStart": "scale(1.05)"});
})();
